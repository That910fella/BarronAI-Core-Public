...
# DUP-REMOVED: @app.get("/api/broker/health")
# DUP-REMOVED: def api_broker_health():
# DUP-REMOVED:     if not ALPACA_CLIENT:
# DUP-REMOVED:         return {"ok": False, "error": "alpaca not configured"}
# DUP-REMOVED:     return ALPACA_CLIENT.health()
# DUP-REMOVED: 
# DUP-REMOVED: @app.post("/api/broker/orders")
# DUP-REMOVED: def api_broker_orders(payload: Dict[str, Any] = Body(...)):
# DUP-REMOVED:     if not ALPACA_CLIENT:
# DUP-REMOVED:         return {"ok": False, "error": "alpaca not configured"}
# DUP-REMOVED:     sym   = str(payload.get("ticker", "")).upper()
# DUP-REMOVED:     side  = str(payload.get("side", "")).lower()
# DUP-REMOVED:     qty   = int(payload.get("qty", 0))
# DUP-REMOVED:     limit = payload.get("limit", None)
# DUP-REMOVED:     if not sym or side not in ("buy", "sell") or qty <= 0:
# DUP-REMOVED:         return {"ok": False, "error": "invalid params"}
# DUP-REMOVED:     return ALPACA_CLIENT.submit_order(sym, side, qty, limit)
# DUP-REMOVED: 
# DUP-REMOVED: @app.get("/api/broker/positions")
# DUP-REMOVED: def api_broker_positions():
# DUP-REMOVED:     if not ALPACA_CLIENT:
# DUP-REMOVED:         return {"ok": False, "error": "alpaca not configured"}
# DUP-REMOVED:     return ALPACA_CLIENT.positions()
# DUP-REMOVED: # END ALPACA BLOCK
# DUP-REMOVED: # -------- Alpaca broker extras --------
# DUP-REMOVED: from typing import Any, Dict, Optional
# DUP-REMOVED: import os
# DUP-REMOVED: from fastapi import Body, Path
# DUP-REMOVED: 
# DUP-REMOVED: try:
# DUP-REMOVED:     from .broker_alpaca import Alpaca  # type: ignore
# DUP-REMOVED: except Exception:
# DUP-REMOVED:     Alpaca = None  # type: ignore
# DUP-REMOVED: 
# DUP-REMOVED: ALPACA_CLIENT: Optional["Alpaca"] = None
# DUP-REMOVED: AK = os.getenv("ALPACA_KEY_ID")
# DUP-REMOVED: AS = os.getenv("ALPACA_SECRET_KEY")
# DUP-REMOVED: AU = os.getenv("ALPACA_BASE_URL", "https://paper-api.alpaca.markets/v2")
# DUP-REMOVED: if Alpaca and AK and AS:
# DUP-REMOVED:     ALPACA_CLIENT = Alpaca(AU, AK, AS)
# DUP-REMOVED: 
# DUP-REMOVED: @app.get("/api/broker/debug")
# DUP-REMOVED: def api_broker_debug():
# DUP-REMOVED:     kid = os.getenv("ALPACA_KEY_ID", "")
# DUP-REMOVED:     return {
# DUP-REMOVED:         "base_url": os.getenv("ALPACA_BASE_URL"),
# DUP-REMOVED:         "key_loaded": bool(kid),
# DUP-REMOVED:         "key_preview": f"{kid[:4]}...{kid[-4:]}" if kid else None,
# DUP-REMOVED:     }
# DUP-REMOVED: 
# DUP-REMOVED: @app.get("/api/broker/health")
# DUP-REMOVED: def api_broker_health():
...
# DUP-REMOVED:     qty   = int(payload.get("qty", 0))
# DUP-REMOVED:     limit = payload.get("limit", None)
# DUP-REMOVED:     ext   = bool(payload.get("extended_hours", False))
# DUP-REMOVED:     if not sym or side not in ("buy", "sell") or qty <= 0:
# DUP-REMOVED:         return {"ok": False, "error": "invalid params"}
# DUP-REMOVED:     return ALPACA_CLIENT.submit_order(sym, side, qty, limit, extended_hours=ext)
# DUP-REMOVED: 
# DUP-REMOVED: @app.get("/api/broker/orders")
# DUP-REMOVED: def api_broker_list_orders(status: str = "all", limit: int = 50):
# DUP-REMOVED:     if not ALPACA_CLIENT:
# DUP-REMOVED:         return {"ok": False, "error": "alpaca not configured"}
# DUP-REMOVED:     return ALPACA_CLIENT.list_orders(status=status, limit=limit)
# DUP-REMOVED: 
# DUP-REMOVED: @app.get("/api/broker/orders/{order_id}")
# DUP-REMOVED: def api_broker_get_order(order_id: str = Path(...)):
# DUP-REMOVED:     if not ALPACA_CLIENT:
# DUP-REMOVED:         return {"ok": False, "error": "alpaca not configured"}
# DUP-REMOVED:     return ALPACA_CLIENT.get_order(order_id)
# DUP-REMOVED: 
# DUP-REMOVED: @app.delete("/api/broker/orders/{order_id}")
# DUP-REMOVED: def api_broker_cancel_order(order_id: str = Path(...)):
# DUP-REMOVED:     if not ALPACA_CLIENT:
# DUP-REMOVED:         return {"ok": False, "error": "alpaca not configured"}
# DUP-REMOVED:     return ALPACA_CLIENT.cancel_order(order_id)
# DUP-REMOVED: 
# DUP-REMOVED: @app.get("/api/broker/positions")
# DUP-REMOVED: def api_broker_positions():
# DUP-REMOVED:     if not ALPACA_CLIENT:
# DUP-REMOVED:         return {"ok": False, "error": "alpaca not configured"}
# DUP-REMOVED:     return ALPACA_CLIENT.positions()
# DUP-REMOVED: # -------- Alpaca broker: close/flatten helpers --------
# DUP-REMOVED: from typing import Any, Dict, Optional
# DUP-REMOVED: import os
# DUP-REMOVED: from fastapi import Body, Path, Query
# DUP-REMOVED: 
# DUP-REMOVED: try:
# DUP-REMOVED:     from .broker_alpaca import Alpaca  # type: ignore
# DUP-REMOVED: except Exception:
# DUP-REMOVED:     Alpaca = None  # type: ignore
# DUP-REMOVED: 
# DUP-REMOVED: # Reuse a single global client if creds exist
# DUP-REMOVED: ALPACA_CLIENT: Optional["Alpaca"] = None
# DUP-REMOVED: AK = os.getenv("ALPACA_KEY_ID")
# DUP-REMOVED: AS = os.getenv("ALPACA_SECRET_KEY")
# DUP-REMOVED: AU = os.getenv("ALPACA_BASE_URL", "https://paper-api.alpaca.markets/v2")
...
# DUP-REMOVED:     ALPACA_CLIENT = Alpaca(AU, AK, AS)
# DUP-REMOVED: 
# DUP-REMOVED: @app.post("/api/broker/close/{symbol}")
# DUP-REMOVED: def api_broker_close_position(symbol: str = Path(..., min_length=1)):
# DUP-REMOVED:     if not ALPACA_CLIENT:
# DUP-REMOVED:         return {"ok": False, "error": "alpaca not configured"}
# DUP-REMOVED:     return ALPACA_CLIENT.close_position(symbol)
# DUP-REMOVED: 
# DUP-REMOVED: @app.post("/api/broker/flatten")
# DUP-REMOVED: def api_broker_flatten():
# DUP-REMOVED:     if not ALPACA_CLIENT:
# DUP-REMOVED:         return {"ok": False, "error": "alpaca not configured"}
# DUP-REMOVED:     cancel = ALPACA_CLIENT.cancel_all_orders()
# DUP-REMOVED:     close  = ALPACA_CLIENT.close_all_positions()
# DUP-REMOVED:     return {"ok": cancel.get("ok") and close.get("ok"), "cancel": cancel, "close": close}
# DUP-REMOVED: 
# DUP-REMOVED: # Optional tidy list/cancel if not present
# DUP-REMOVED: @app.get("/api/broker/orders")
# DUP-REMOVED: def api_broker_list_orders(status: str = Query("all"), limit: int = Query(50, ge=1, le=500)):
# DUP-REMOVED:     if not ALPACA_CLIENT:
# DUP-REMOVED:         return {"ok": False, "error": "alpaca not configured"}
# DUP-REMOVED:     return ALPACA_CLIENT.list_orders(status=status, limit=limit)
# DUP-REMOVED: 
# DUP-REMOVED: @app.delete("/api/broker/orders/{order_id}")
# DUP-REMOVED: def api_broker_cancel(order_id: str = Path(..., min_length=8)):
# DUP-REMOVED:     if not ALPACA_CLIENT:
# DUP-REMOVED:         return {"ok": False, "error": "alpaca not configured"}
# DUP-REMOVED:     return ALPACA_CLIENT.cancel_order(order_id)
# DUP-REMOVED: 
# DUP-REMOVED: # --- include broker routes (oh-crap panel + APIs)
# DUP-REMOVED: try:
# DUP-REMOVED:     from .routes_broker import router as _broker_router  # type: ignore
# DUP-REMOVED:     app.include_router(_broker_router)
# DUP-REMOVED: except Exception as _e:
# DUP-REMOVED:     print("Broker router not loaded:", _e)
# DUP-REMOVED: from fastapi.responses import HTMLResponse
# DUP-REMOVED: 
